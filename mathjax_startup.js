...
if (!is_mobile) {
  load_external_js({src:"/spotter_js/3.0.4/mathjax_config.js",type:"text/x-mathjax-config"});
    // FIXME -- This URL will break as soon as the version number changes.
    // If I do it without a directory, I now get this in the js console:
    //   Loading failed for the <script> with http://localhost/cgi-bin/spotter3/mathjax_config.js
    //   I.e., it used to be relative to the js file's own directory, but is now relative to cgi-bin by default.
